...
STATE_DIR = Path(os.getenv("REEF_STATE_DIR", "/var/data")).expanduser()
try:
...
STATE_FILE = STATE_DIR / "reef_trade_state.json"
...
def main():
    ...
    print("=" * 60)
    print("REEF ONE FILE BOT V12 - PERSISTENT CONTRACT STATE")
    print("=" * 60)
